...
export function Detail() {
  ...
  useLayoutEffect(() => {
    ...
    navigation.setOptions({
      title: route.params?.data
        ...
        : "Detalhes da receita",
      headerRight: () => (
        <Pressable onPress={() => handleRavoriteReceipe(route.params?.data)}>
          {favorite ? (
  ...
  async function handleRavoriteReceipe(receipe) {
    if (favorite) {
    ...
    >
      ...
      <View style={styles.headerDetails}>
        <View>
          ...
          <Text style={styles.ingredinetsText}>
      ...
      {/* Repetição para pegar a quantidades de ingredinetes que existe na api de forma automática*/}
      ...
      {/* Repetição para pegar a quantidades de instruções que existe na api de forma automática*/}
